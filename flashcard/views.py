...
def iniciar_desafio(request):
    if request.method == "GET":
        ...
        # se tiver menos flashcards do que qtd_pergunta vai dar erro
...
def desafio(request, id):
    ...
    if request.method == "GET":
        ...
        faltante = desafio.flashcards.filter(respondido = False).count

        return render(request,'desafio.html',
            {'desafio': desafio, 'acertos': acertos,'erros':erros, 'faltante':faltante})
